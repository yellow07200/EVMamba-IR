...
class CropParameters:
    ...
    def __init__(self, width, height, num_encoders, safety_margin=0):
        ...
        self.width_crop_size = num_encoders
        self.height_crop_size = num_encoders
        ...
        print('self.padding_left: ', self.padding_left, ', self.padding_right: ', self.padding_right, ',self.padding_top: ', self.padding_top)
    def crop(self, img):
