...
from utils.datasets import E2VIDDataset
...
if __name__ == '__main__':
    # root_dir = 'ECNN_TRAIN/'
    root_dir = '/mnt/mhd/esim_coco/event_data/ECNN_TRAIN/'
    dataset = E2VIDDataset(root_dir)
    # name = 'Adirondack/'
    H, W = 256, 256
    H_, W_ = 256, 256
    # H, W = 180, 240
    ...
    # for name in names:
        # print(name)
    # save_dir_ts = '/mnt/mhd/esim_coco/event_data/ECNN_TRAIN/ts_imgs/'+name +'/'
    # if not os.path.exists(save_dir_ts):
    #     os.mkdir(save_dir_ts)
    # save_dir_gt = '/mnt/mhd/esim_coco/event_data/ECNN_TRAIN/gt_imgs/'+name +'/'
    # if not os.path.exists(save_dir_gt):
    #     os.mkdir(save_dir_gt)
    # save_dir_op = '/mnt/mhd/esim_coco/event_data/ECNN_TRAIN/op_npy/'+name +'/'
    ...
    for batch in dataloader:
        ...
        # if not os.path.exists(save_dir_ts):
        #     os.mkdir(save_dir_ts)
        save_dir_gt = 'ECNN_TRAIN/gt_imgs/'+name
        if not os.path.exists(save_dir_gt):
            os.mkdir(save_dir_gt)
        # save_dir_op = '/mnt/mhd/esim_coco/event_data/ECNN_TRAIN/op_npy/'+name
        # if not os.path.exists(save_dir_op):
